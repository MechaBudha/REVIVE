...
public class Weapon : MonoBehaviour {
    ...
    {                                                   //Este disparo va a estar hecho con raycast (castea un rayacst y no crea una bala cada vez que dispara)
        if (fireTimer < fireRate || currentBullets <= 0) return;            //Esto seria como el verificador que pregunta si podemos disparar, si el timer terminó, y si las balas llegan a 0 que pare.
